...
export function PrototypeProfessionalRecordNewPage() {
  ...
  return <ProfessionalRecordForm initialDraft={{ ...structuredClone(EMPTY_PROFESSIONAL_RECORD_DRAFT), caseId }} heading="新增專業照顧紀錄" description="記錄本次服務的客觀觀察、實際處置與後續追蹤；觀察不等於診斷。" submitLabel="發布虛構紀錄" caseDisplayName={caseDisplayName} onPublish={publishRecord} />;
}
