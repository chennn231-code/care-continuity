...
import { canAcceptInvitation, canViewInvitationPreview, effectiveInvitationStatus, invitationForPreview } from '../state/invitationWorkspaceState';
...
export function PrototypeInvitationPreviewPage() {
  ...
  const needsVerification = invitation.recipientType === 'PROFESSIONAL' && invitation.professionalVerificationStatus !== 'VERIFIED';
  const accept = () => {
