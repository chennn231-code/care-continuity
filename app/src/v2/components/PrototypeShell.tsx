...
export function PrototypeShell() {
  ...
  const caseActorContext = caseId ? currentCaseActorContext(state, caseId) : null;
  ...
  return (
    <div className="v2-prototype">
      ...
      {isCaseRoute && caseActorContext && <><div className="v2-case-context"><span>目前個案關係：{caseActorContext.relationshipLabel}</span><span>身分狀態：已驗證</span><span>可使用權限：依目前身分與個案關係</span></div><details className="v2-permission-preview">
      ...
      </nav><p className="v2-case-nav-hint" aria-hidden="true">左右滑動查看更多個案功能</p></>}
